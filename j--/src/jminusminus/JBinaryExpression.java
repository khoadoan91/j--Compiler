...
class JReminderOp extends JBinaryExpression {

    /**
     * Construct an AST for a reminder expression given its line number,
     * and the lhs and rhs operands.
     * 
     * @param line
     *            line in which the reminder expression occurs in the
     *            source file.
     * @param lhs
     *            the lhs operand.
     * @param rhs
    ...
    public JReminderOp(int line, JExpression lhs, JExpression rhs) {
        super(line, "%", lhs, rhs);
    }
...
class JRightShiftOp extends JBinaryExpression {
    ...
    /**
     * Construct an AST for a right shift expression given its line number,
     * and the lhs and rhs operands.
     * 
     * @param line
...
class JUnsignedRightShiftOp extends JBinaryExpression {
    ...
    /**
     * Construct an AST for an unsigned right shift expression given its line number,
     * and the lhs and rhs operands.
     * 
     * @param line
     *            line in which the unsigned right shift expression occurs in the
     *            source file.
     * @param lhs
     *            the lhs operand.
     * @param rhs
